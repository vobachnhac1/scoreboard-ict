...
PHẦN MỀM QUẢN LÝ THI ĐẤU VÕ HIỆN ĐẠI
...
Phần mềm "PHẦN MỀM QUẢN LÝ THI ĐẤU Võ Hiện Đại" (sau đây gọi là "Phần mềm")
...
Phần mềm này được cấp phép sử dụng theo các điều khoản sau:

a) Quyền sử dụng:

- Người dùng được cấp quyền sử dụng Phần mềm cho mục đích quản lý
  và tổ chức các giải thi đấu võ thuật.
- Quyền sử dụng chỉ có hiệu lực trong thời gian được ghi trong
  giấy phép kích hoạt.
...
- NGHIÊM CẤM chỉnh sửa, thay đổi hoặc tạo ra các phiên bản
  phái sinh từ Phần mềm.
- NGHIÊM CẤM xóa bỏ hoặc thay đổi các thông báo về bản quyền,
  nhãn hiệu hoặc các thông báo sở hữu khác trong Phần mềm.
...
- Bất kỳ thiệt hại trực tiếp, gián tiếp, ngẫu nhiên, đặc biệt
  ...
  sử dụng Phần mềm.
- Mất mát dữ liệu, gián đoạn kinh doanh, hoặc các thiệt hại
...
Giấy phép sẽ tự động chấm dứt nếu:
...
- Ngừng sử dụng Phần mềm ngay lập tức.
- Xóa bỏ tất cả các bản sao của Phần mềm.

7. LUẬT ÁP DỤNG

Giấy phép này được điều chỉnh bởi pháp luật Việt Nam.

Mọi tranh chấp phát sinh từ hoặc liên quan đến giấy phép này sẽ được
...
BẰNG VIỆC CÀI ĐẶT, SAO CHÉP HOẶC SỬ DỤNG PHẦN MỀM NÀY, BẠN ĐỒNG Ý VỚI
TẤT CẢ CÁC ĐIỀU KHOẢN VÀ ĐIỀU KIỆN CỦA GIẤY PHÉP NÀY.

NẾU BẠN KHÔNG ĐỒNG Ý VỚI CÁC ĐIỀU KHOẢN NÀY, VUI LÒNG KHÔNG CÀI ĐẶT
