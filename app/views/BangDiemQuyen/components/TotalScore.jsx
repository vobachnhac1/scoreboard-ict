...
export default function TotalScore({ total, ...props }) {
  ...
  return (
    <div className="relative group" {...props}>
      ...
      <div className="bg-orange-500 rounded w-[350px] flex flex-col items-center justify-center text-white shadow-[0_10px_40px_rgba(0,0,0,0.4)] border-[2px] border-yellow-400 transform transition-all duration-300 hover:scale-105 hover:shadow-[0_15px_50px_rgba(234,88,12,0.6)] ring-4 ring-yellow-500/30">
        {/* Total label */}
        ...
        {/* Total score */}
        <p className="text-[130px] font-black mt-2 drop-shadow-[0_5px_15px_rgba(0,0,0,0.5)] tracking-tight">
          {total}
        </p>
