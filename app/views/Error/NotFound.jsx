    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 border-2 border-blue-200">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Các trang phổ biến:</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900 group-hover:text-purple-700">Quản lý giải đấu</p>
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900 group-hover:text-green-700">Cấu hình hệ thống</p>
