      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={4}
            className="block px-4 py-3 w-full text-sm font-bold text-blue-900 dark:text-blue-100 bg-blue-50/50 dark:bg-blue-900/10 rounded border-2 border-blue-100 dark:border-blue-800 focus:border-blue-500 outline-none transition-all shadow-inner"
            placeholder="Nhập nội dung cần gửi đến giám định..."
          />
        </div>

        <div className="bg-blue-50/30 dark:bg-blue-900/10 rounded p-6 border border-blue-50 dark:border-blue-900/30 shadow-inner">
            ...
            <label className="flex items-center group cursor-pointer select-none">
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="peer appearance-none w-6 h-6 border-2 border-blue-200 dark:border-blue-800 rounded bg-white dark:bg-gray-800 checked:bg-amber-500 checked:border-amber-500 transition-all duration-300 hover:border-amber-400"
                />
            ...
            <label className="flex items-center group cursor-pointer select-none">
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  onChange={handleChange}
                  className="peer appearance-none w-6 h-6 border-2 border-blue-200 dark:border-blue-800 rounded bg-white dark:bg-gray-800 checked:bg-rose-500 checked:border-rose-500 transition-all duration-300 hover:border-rose-400"
                />
                <svg className="absolute w-4 h-4 text-white opacity-0 peer-checked:opacity-100 transition-opacity duration-300 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
