      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-5 py-2.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded text-[10px] font-black uppercase tracking-widest border-2 border-blue-100 dark:border-blue-800 hover:bg-blue-600 hover:text-white transition-all active:scale-95 flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-5 py-2.5 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 rounded text-[10px] font-black uppercase tracking-widest border-2 border-gray-100 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all active:scale-95 flex items-center gap-2"
          >
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="w-5 h-5 rounded border-2 border-blue-200 text-blue-600 focus:ring-blue-500 focus:ring-offset-0 transition-all opacity-0 absolute"
                />
                <div className={`w-8 h-8 rounded flex items-center justify-center transition-all ${isSelected ? 'bg-blue-600 text-white' : 'bg-blue-50 dark:bg-blue-900/30 text-blue-200 group-hover:text-blue-400'}`}>
