  ...
  return (
    <div className="flex flex-col items-center max-w-sm mx-auto py-4">
      ...
      <div className="relative mb-6">
        ...
        <div className="relative w-20 h-20 bg-blue-50 dark:bg-blue-900/40 rounded flex items-center justify-center border-2 border-white dark:border-gray-800 shadow-xl">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md justify-center mt-4">
        <button
          onClick={onCancel}
          className="flex-1 px-8 py-4 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 rounded text-[11px] font-black uppercase tracking-widest transition-all active:scale-95 border-2 border-transparent hover:border-gray-300 dark:hover:border-gray-600"
        >
          {t("competition_detail.buttons.cancel")}
        </button>
        <button
          onClick={onConfirm}
          className="flex-1 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded text-[11px] font-black uppercase tracking-widest shadow-xl shadow-blue-500/30 transition-all active:scale-95 flex items-center justify-center gap-2 group"
        >
