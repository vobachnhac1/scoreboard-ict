  ...
  return (
    <div className="flex flex-col items-center text-center space-y-8">
      ...
      <div className="relative group">
        <div className="relative w-24 h-24 bg-rose-50 dark:bg-rose-950 rounded flex items-center justify-center border border-rose-100 dark:border-rose-800">
      ...
      <div className="flex items-center gap-4 w-full">
        ...
        <button
          onClick={onConfirm}
          className="flex-1 py-4 px-6 rounded bg-rose-600 text-white font-bold transition-all active:scale-95 uppercase tracking-widest text-[11px]"
        >
