...
; Tiếng Việt (1066)
LangString WELCOME_TITLE 1066 "Hệ thống Quản lý Thi đấu & Chấm điểm DigiSports"
LangString WELCOME_TEXT 1066 "Chào mừng quý khách đến với quy trình thiết lập DigiSports Professional.$\n$\nPhần mềm được thiết kế với công nghệ hiện đại, cung cấp giải pháp số hóa cho công tác trọng tài, điều hành sân thi đấu và hiển thị kết quả thời gian thực.$\n$\nVui lòng nhấn 'Tiếp tục' để bắt đầu quá trình cài đặt hệ thống."
LangString FINISH_TITLE 1066 "Thiết lập Hệ thống Hoàn tất"
LangString FINISH_TEXT 1066 "Phần mềm DigiSports đã được cài đặt thành công và sẵn sàng để sử dụng.$\n$\nChúc quý khách có những giải đấu thành công rực rỡ với sự hỗ trợ của công nghệ DigiSports."
...
!macro customHeader
  BrandingText "DigiSports Technology © 2026 - Giải pháp chuyển đổi số"

  ; Tinh chỉnh giao diện Modern UI
  !define MUI_ABORTWARNING ; Hiện cảnh báo khi người dùng nhấn thoát giữa chừng
  !define MUI_COMPONENTSPAGE_NODESC ; Ẩn mô tả thành phần nếu không cần thiết để UI sạch hơn
